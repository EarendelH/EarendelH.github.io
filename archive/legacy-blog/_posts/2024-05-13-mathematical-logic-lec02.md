...
permalink: /blog/2024/05/13/mathematical-logic-lec02/
categories:
  - "Logic Math"
tags:
---
...
![image](/images/blog/mathematical-logic-lec02/img1.png)

- 集合中可以重复，且无序。
![img](/images/blog/mathematical-logic-lec02/img2.png)
- subset：子集
  Proper subset 真子集
  **Power set 幂集**：含有该集合的所有子集
![image](/images/blog/mathematical-logic-lec02/img3.png)
- set operations
![image](/images/blog/mathematical-logic-lec02/img4.png)
- **n-tuples**:有序n元组
...
![img](/images/blog/mathematical-logic-lec02/img5.png)

- **n-ary relation**多元关系
 ![img](/images/blog/mathematical-logic-lec02/img6.png)

## Equivalence Relation

- **Equivalence Relation**等价关系
  - 如果R是一个等价关系，R要满足三个性质：reflexive(自反)、symmetric(对称)、transitive(传递)。
![img](/images/blog/mathematical-logic-lec02/img7.png)
  - 比如说“=”关系就是最基本的等价关系
![img](/images/blog/mathematical-logic-lec02/img8.png)
...
- 偏序关系满足三个性质
  ...
  - transitive 传递
![img](/images/blog/mathematical-logic-lec02/img9.png)
- 一个有意思的例子
...
![img](/images/blog/mathematical-logic-lec02/img10.png)
...
![img](/images/blog/mathematical-logic-lec02/img11.png)

- domain 定义域
- codomain 陪域，上域
- range 值域
![img](/images/blog/mathematical-logic-lec02/img12.png)
- injective:单射或一一映射
- Surjective:满射
- bijective:双射
![img](/images/blog/mathematical-logic-lec02/img13.png)
 rigorously:严格地
